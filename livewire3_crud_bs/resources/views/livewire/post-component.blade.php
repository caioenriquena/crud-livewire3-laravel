                            ...
                            <div class="modal-body">
                                <form wire:submit="{{ $postId ? 'update' : 'store' }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" wire:model="form.body" id="body" rows="4"
                                                  placeholder="Enter post body"></textarea>
                                        <span class="text-danger">@error('form.body') {{ $message }} @enderror</span>
                                    </div>
                                    <button type="submit" class="btn btn-primary mt-4">
                                        {{ $postId ? 'Update' : 'Create' }}
                                    </button>
                                    <button type="button" wire:click="closeModal" class="btn btn-secondary mt-4">Close
                                    </button>
                                </form>
                            </div>
                        </div>
